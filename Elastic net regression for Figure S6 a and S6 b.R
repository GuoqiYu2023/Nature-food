...
Figure S6a<-pheatmap(data, cluster_row = TRUE,cluster_cols = FALSE,border_color = "black", 
                                        display_numbers = TRUE,        
                                        number_color = "black",         
                                        fontsize=10,                   
                                        number_format = "%.2f")            
pdf("Figure S6a.pdf", width = 6, height = 6)
print(Figure S6a)
dev.off()
...
jpeg("Figure S6b.jpeg", height=3000,width=3000,bg="white",res = 600)
...
Figure S6b<-pheatmap(data, cluster_row = TRUE,cluster_cols = FALSE,border_color = "black",
                                                         display_numbers = TRUE,         
                                                         number_color = "black",       
                                                         fontsize=10,                  
                                                         number_format = "%.2f")       
pdf("Figure S6b.pdf", width = 6, height = 6)
print(Figure S6b)
dev.off()
